...
package wchar_h is
  ...
  -- Conversion state information.   
   subtype anon1041_uu_wchb_array is Interfaces.C.char_array (0 .. 3);
   type anon_1041 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_wch : aliased unsigned;  -- /usr/include/wchar.h:88
         when others =>
            uu_wchb : aliased anon1041_uu_wchb_array;  -- /usr/include/wchar.h:92
      end case;
   end record;
   pragma Convention (C_Pass_By_Copy, anon_1041);
   pragma Unchecked_Union (anon_1041);  -- /usr/include/wchar.h:85
  ...
  -- Value so far.   
   ...
   pragma Unchecked_Union (uu_mbstate_t_uu_value_union);
   type uu_mbstate_t is record
      uu_count : aliased int;  -- /usr/include/wchar.h:84
      uu_value : uu_mbstate_t_uu_value_union;  -- /usr/include/wchar.h:93
   end record;
